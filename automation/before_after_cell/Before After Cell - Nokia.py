...
### Inputs ###
change_date = pd.to_datetime('2/26/2018')
cell = 'ABA cluster'
coverage_category = 'Undershooter'
results_filename = 'Coverage - ' + cell
category_filename = 'Coverage KPIs Nokia'
path=r"C:\Users\ejohnso43\Documents\1_2018\Dominance\Markets\Houston\KPIs\Results"
os.chdir(path)
...
df = df.drop('WS_DUMMY', axis = 'columns')
